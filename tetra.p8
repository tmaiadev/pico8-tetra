...
intro.new=function()
	...
	-- instructions
	self.inst_txt="press ❎ to start"
	self.inst_shw=false
	self.inst_clr=0
	self.inst_ani=ani.new(4, true)

	-- level selection
	self.level=1
	self.level_shw=false
	
	self:_mk_presents_ani()
	self:_mk_pandown_ani()
	self:_mk_inst_ani() -- instructions
	
	self.presents_ani:start()
	self.presents_ani.on_end=
	function()
		self.pandown_ani:start()
		self.inst_shw=true
		self.inst_ani:start()
	end
...
intro.update=function(self)
	if self.presents_ani.started
	and not self.presents_ani.ended
	then
		self.presents_ani:update()
	end
	
	if self.pandown_ani.started
	and not self.pandown_ani.ended
	then
		self.pandown_ani:update()
	end
	
	if self.inst_ani.started
	and not self.level_shw
	then
		self.inst_ani:update()
...
intro.draw=function(self)
	cls()
	
	if self.presents_shw then
		local txt="tmaiadev presents"
		print(
			txt,
			64-#txt*4/2,
			60,
	...
	if self.level_shw then
		...
		printc(
			"⬇️",
			102,
			can_mv_down and 7 or 5
		)
	end
end

intro._mk_presents_ani=function(self)
	-- nothing for 1 sec
	self.presents_ani:add(function()
	end, self.presents_fps)
	
	-- show
	self.presents_ani:add(function()
		self.presents_shw=true
		self.presents_clr=5
	end)
	...
	-- for 2 secs
	self.presents_ani:add(function()
		local clr=self.presents_clr+1
		self.presents_clr=
			max(5, min(7, clr))
	end, self.presents_fps*3)
...
intro._mk_pandown_ani=function(self)
	self.pandown_ani:add(function(frame)
		local init_pos=-100
		local scrolled=easing(
			frame/self.pandown_fps
		)*(init_pos*-1)
		
		self.pandown_y=init_pos+scrolled	
	end, self.pandown_fps)
end

intro._mk_inst_ani=function(self)
	local colors={0,5,6,7,7,7,6,5,0}
	self.inst_ani:add(function(frame)
		self.inst_clr=colors[frame]
	end, #colors);
end
-->8
-- game (gm)
...
__map__

__sfx__
...

